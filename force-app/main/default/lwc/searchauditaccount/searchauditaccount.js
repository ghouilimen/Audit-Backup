...
import getAcc from '@salesforce/apex/AuditActions.getAcc';
...
export default class Searchauditaccount  extends NavigationMixin(LightningElement) {
    @track value;
    @track error;
    @track data;
    ...
    @wire(getAcc, {searchKey: '$searchKey', sortBy: '$sortedBy', sortDirection: '$sortedDirection'})
